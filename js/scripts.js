...
$(document).ready(function(){
    $.ajax({
        ...
        data.forEach(function(contributors){
          var html = '<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 text-center"> <div class="card hvr-hang single-mentor">';
          ...
          $.ajax({
            ...
            html += '<br>';
            html += '<a href="https://github.com/fossasia/gci18.fossasia.org/commits?author='+contributors.login+'">';
            html += '('+contributors.contributions;
            if (contributors.contributions === 1) {
              html += ' contribution)</p></a><br>';
            } else {
              html += ' contributions)</p></a><br>';
            }
